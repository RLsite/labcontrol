...
const DICT = {
  en: {
    ...
    reserve: { title: "Reserve a Device", device: "Device", start: "Start", end: "End", purpose: "Purpose (optional)", purposePlaceholder: "Brief description of the experiment...", create: "Create Reservation", creating: "Saving...", saved: "Reservation saved", syncGoogle: "Sync to Google Calendar", syncNote: "Opens Google Calendar with the reservation details." },
    ...
    settings: { title: "Settings", subtitle: "Manage connections and language", language: { title: "Language", desc: "Choose the display language", he: "עברית", en: "English" }, connections: { title: "Connections", desc: "Manage integrations with external services", googleCalendar: "Google Calendar", googleCalendarDesc: "Sync device reservations to Google Calendar.", connected: "Connected", openBtn: "Open Google Calendar", manageNote: "The lab calendar is local to each lab. Google Calendar sync is an optional add-on per reservation." } }
  },
  he: {
    ...
    reserve: { title: "הזמן מכשיר", device: "מכשיר", start: "התחלה", end: "סיום", purpose: "מטרה (לא חובה)", purposePlaceholder: "תיאור קצר...", create: "צור הזמנה", creating: "שומר...", saved: "ההזמנה נשמרה", syncGoogle: "סנכרן ל-Google Calendar", syncNote: "פותח את Google Calendar עם פרטי ההזמנה." },
    ...
    settings: { title: "הגדרות", subtitle: "נהל חיבורים ושפה", language: { title: "שפה", desc: "בחר את שפת התצוגה", he: "עברית", en: "English" }, connections: { title: "חיבורים", desc: "נהל אינטגרציות", googleCalendar: "Google Calendar", googleCalendarDesc: "סנכרון הזמנות ל-Google Calendar.", connected: "מחובר", openBtn: "פתח ב-Google Calendar", manageNote: "היומן מקומי לכל מעבדה. סנכרון Google Calendar הוא אופציונלי לכל הזמנה." } }
  }
};
