...
const DICT = {
  en: {
    ...
    nav: { dashboard: "Dashboard", calendar: "Lab Calendar", manage: "Manage", help: "Help", settings: "Settings", labs: "Labs", reports: "Reports" },
    role: { mainAdmin: "Main Admin", labAdmin: "Lab Admin", seniorUser: "Senior User", user: "User", unknown: "User" },
    common: { logout: "Logout", close: "Close", loading: "Loading...", cancel: "Cancel", refresh: "Refresh", save: "Save", create: "Create", back: "Back", lightMode: "Light view", darkMode: "Dark view" },
    ...
    reserve: { title: "Reserve a Device", device: "Device", start: "Start", end: "End", purpose: "Purpose (optional)", purposePlaceholder: "Brief description of the experiment...", create: "Create Reservation", newBtn: "New Reservation", noDevices: "Add devices first to create reservations.", creating: "Saving...", saved: "Reservation saved", syncGoogle: "Add to Google Calendar", syncOutlook: "Add to Outlook Calendar", viewLocal: "View in local calendar", syncNote: "Add this reservation to your external calendar via a direct link." },
    ...
    lab: { title: "Labs", overview: "Labs Overview", overviewSub: "Manage all labs in the system", createLab: "Create Lab", labName: "Lab name", description: "Description", location: "Location", create: "Create Lab", noLabs: "No labs yet", noLabsDesc: "Create your first lab to get started.", members: "Members", devices: "Devices", calendar: "Calendar", localCalendar: "Local Calendar", labCalendar: "Lab Calendar", labCalendarSub: "Reservations for this lab", calendarEmpty: "No reservations yet. Click a day or New Reservation to book.", selectLab: "Select a lab", noLab: "Not assigned to a lab", open: "Open", totalDevices: "devices", activeNow: "active now", allDevices: "All devices" },
    manage: { title: "Management", subtitle: "Manage users, devices and labs", pending: "Pending Approval", users: "Users", devices: "Device Status", labs: "Labs", noPending: "No users pending approval.", approve: "Approve", block: "Block", assignLab: "Assign lab", assignRole: "Role", noAccess: "No Access", noAccessDesc: "Management is available to admins only.", unassigned: "Unassigned", role: "Role", save: "Save", allLabs: "All labs", filterByLab: "Filter by lab", remove: "Remove user", confirmRemoveUser: "Remove this user from the system? This cannot be undone." },
    reports: { title: "Reports & Analytics", subtitle: "Usage insights across your labs", totalReservations: "Total reservations", bookedHours: "Booked hours", totalSessions: "Work sessions", devices: "Devices", byDevice: "Reservations by device", topUsers: "Top users by sessions", noData: "No usage data yet. Reservations and work sessions will appear here." },
    labManage: { backToLabs: "Back to labs", devices: "Devices", members: "Members", addDevice: "Add Device", inviteUser: "Invite User", noDevices: "No devices yet", noDevicesDesc: "Add your first device to this lab.", noMembers: "No members yet", noMembersDesc: "Invite users to join this lab.", deviceName: "Device name", deviceImage: "Device image", uploadImage: "Upload image", category: "Category", categoryPh: "e.g. Microscope, 3D Printer", location: "Location", description: "Description", requiresTraining: "Requires training", trainingName: "Training name", email: "Email", fullName: "Full name", role: "Role", inviting: "Inviting...", confirmDeleteDevice: "Delete this device?", confirmRemoveMember: "Remove this member from the lab?", deleteLab: "Delete lab", confirmDeleteLab: "Delete this lab and all its devices and reservations? Members will be unassigned." },
  ...
  he: {
    ...
    nav: { dashboard: "לוח בקרה", calendar: "יומן מעבדה", manage: "ניהול", help: "עזרה", settings: "הגדרות", labs: "מעבדות", reports: "דוחות" },
    role: { mainAdmin: "מנהל ראשי", labAdmin: "מנהל מעבדה", seniorUser: "משתמש בכיר", user: "משתמש", unknown: "משתמש" },
    common: { logout: "התנתק", close: "סגור", loading: "טוען...", cancel: "ביטול", refresh: "רענן", save: "שמור", create: "צור", back: "חזור", lightMode: "תצוגה בהירה", darkMode: "תצוגה כהה" },
    ...
    reserve: { title: "הזמן מכשיר", device: "מכשיר", start: "התחלה", end: "סיום", purpose: "מטרה (לא חובה)", purposePlaceholder: "תיאור קצר...", create: "צור הזמנה", newBtn: "הזמנה חדשה", noDevices: "הוסף מכשירים תחילה כדי ליצור הזמנות.", creating: "שומר...", saved: "ההזמנה נשמרה", syncGoogle: "הוסף ל-Google Calendar", syncOutlook: "הוסף ל-Outlook Calendar", viewLocal: "צפה ביומן המקומי", syncNote: "הוסף הזמנה זו ליומן החיצוני שלך בקישור ישיר." },
    ...
    lab: { title: "מעבדות", overview: "סקירת מעבדות", overviewSub: "נהל את כל המעבדות במערכת", createLab: "צור מעבדה", labName: "שם מעבדה", description: "תיאור", location: "מיקום", create: "צור מעבדה", noLabs: "אין מעבדות", noLabsDesc: "צור את המעבדה הראשונה.", members: "חברים", devices: "מכשירים", calendar: "יומן", localCalendar: "יומן מקומי", labCalendar: "יומן מעבדה", labCalendarSub: "הזמנות למעבדה זו", calendarEmpty: "אין הזמנות עדיין. לחץ על יום או 'הזמנה חדשה' כדי לקבוע.", selectLab: "בחר מעבדה", noLab: "לא משויך למעבדה", open: "פתח", totalDevices: "מכשירים", activeNow: "פעילים כעת", allDevices: "כל המכשירים" },
    manage: { title: "ניהול", subtitle: "נהל משתמשים, מכשירים ומעבדות", pending: "ממתינים לאישור", users: "משתמשים", devices: "סטטוס מכשירים", labs: "מעבדות", noPending: "אין משתמשים הממתינים לאישור.", approve: "אשר", block: "חסום", assignLab: "שייך למעבדה", assignRole: "תפקיד", noAccess: "אין הרשאה", noAccessDesc: "הניהול זמין למנהלים בלבד.", unassigned: "לא משויך", role: "תפקיד", save: "שמור", allLabs: "כל המעבדות", filterByLab: "סינון לפי מעבדה", remove: "הסר משתמש", confirmRemoveUser: "להסיר משתמש זה מהמערכת? פעולה זו אינה הפיכה." },
    reports: { title: "דוחות וניתוח נתונים", subtitle: "תובנות שימוש במעבדות שלך", totalReservations: "סה\"כ הזמנות", bookedHours: "שעות מוזמנות", totalSessions: "סשני עבודה", devices: "מכשירים", byDevice: "הזמנות לפי מכשיר", topUsers: "משתמשים מובילים לפי סשנים", noData: "אין עדיין נתוני שימוש. הזמנות וסשני עבודה יופיעו כאן." },
    labManage: { backToLabs: "חזרה למעבדות", devices: "מכשירים", members: "חברים", addDevice: "הוסף מכשיר", inviteUser: "הזמן משתמש", noDevices: "אין מכשירים עדיין", noDevicesDesc: "הוסף את המכשיר הראשון למעבדה זו.", noMembers: "אין חברים עדיין", noMembersDesc: "הזמן משתמשים להצטרף למעבדה זו.", deviceName: "שם מכשיר", deviceImage: "תמונת מכשיר", uploadImage: "העלה תמונה", category: "קטגוריה", categoryPh: "לדוגמה: מיקרוסקופ, מדפסת תלת-מימד", location: "מיקום", description: "תיאור", requiresTraining: "דורש הדרכה", trainingName: "שם ההדרכה", email: "אימייל", fullName: "שם מלא", role: "תפקיד", inviting: "מזמין...", confirmDeleteDevice: "למחוק מכשיר זה?", confirmRemoveMember: "להסיר חבר זה מהמעבדה?", deleteLab: "מחק מעבדה", confirmDeleteLab: "למחוק מעבדה זו ואת כל המכשירים וההזמנות שלה? החברים ינותקו." },
