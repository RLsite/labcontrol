...
const DICT = {
  en: {
    ...
    manage: { title: "Management", subtitle: "Manage users, devices and labs", pending: "Pending Approval", users: "Users", devices: "Device Status", labs: "Labs", noPending: "No users pending approval.", approve: "Approve", block: "Block", assignLab: "Assign lab", assignRole: "Role", noAccess: "No Access", noAccessDesc: "Management is available to admins only.", unassigned: "Unassigned", role: "Role", save: "Save", allLabs: "All labs", filterByLab: "Filter by lab" },
