...
const DICT = {
  ...
  he: {
    ...
    labManage: { backToLabs: "חזרה למעבדות", devices: "מכשירים", members: "חברים", addDevice: "הוסף מכשיר", inviteUser: "הזמן משתמש", noDevices: "אין מכשירים עדיין", noDevicesDesc: "הוסף את המכשיר הראשון למעבדה זו.", noMembers: "אין חברים עדיין", noMembersDesc: "הזמן משתמשים להצטרף למעבדה זו.", deviceName: "שם מכשיר", category: "קטגוריה", categoryPh: "לדוגמה: מיקרוסקופ, מדפסת תלת-מימד", location: "מיקום", description: "תיאור", requiresTraining: "דורש הדרכה", trainingName: "שם ההדרכה", email: "אימייל", fullName: "שם מלא", role: "תפקיד", inviting: "מזמין...", confirmDeleteDevice: "למחוק מכשיר זה?", confirmRemoveMember: "להסיר חבר זה מהמעבדה?" },
